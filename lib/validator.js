...
<<<<<<< HEAD
  if (name.match(/^(equals|required|check|validate|assert|error|len|isNumeric|isDecimal|isFloat|regex|notRegex|is|not)$/))
=======
  if (name.match(/^(equals|check|validate|assert|error|len|isNumeric|isDecimal|isFloat|regex|notRegex|is|not|notNull|isNull)$/))
>>>>>>> 883176384570e1a983d595c712d6fa352d50b265
    return;
